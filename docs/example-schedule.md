...
> Status: **OPTIMAL** | Makespan: **315** time units | Waves: **14** | Agents: **5**
...
- **T014** [US2] t=71→115 | `src/models/task.ts`
...
- **T016** [US2] t=115→150 | `src/services/task.ts`
- **T018** [US2] t=175→210 | `src/api/tasks.ts`
- **T002** [Setup] t=210→245 | `.env`
...
- **T015** [US2] t=115→139 | `tests/api/task.test.ts`
...
### Wave 4 (t=70) — User Story 1

| Task | Agent | Duration | Files | Phase |
|------|-------|----------|-------|-------|
| T009 | tester | 24 | `tests/api/project.test.ts` | US1 |
| T010 | backend-2 | 35 | `src/services/project.ts` | US1 |

### Wave 5 (t=71) — User Story 2

| Task | Agent | Duration | Files | Phase |
|------|-------|----------|-------|-------|
| T014 | architect | 44 | `src/models/task.ts` | US2 |

### Wave 6 (t=105) — User Story 1

| Task | Agent | Duration | Files | Phase |
|------|-------|----------|-------|-------|
| T011 | backend-1 | 35 | `src/api/projects.ts` | US1 |

### Wave 7 (t=115) — User Story 2
...
### Wave 8 (t=119) — Foundational

| Task | Agent | Duration | Files | Phase |
|------|-------|----------|-------|-------|
| T004 | architect | 75 | `src/models/schema.sql` | Foundational |

### Wave 9 (t=140) — User Story 1 + User Story 3

| Task | Agent | Duration | Files | Phase |
|------|-------|----------|-------|-------|
| T012 | frontend | 35 | `src/components/ProjectList.tsx` | US1 |
| T021 | backend-1 | 35 | `src/models/comment.ts` | US3 |

### Wave 10 (t=175) — User Story 1 + User Story 2 + User Story 3
...
### Wave 11 (t=194) — Polish

| Task | Agent | Duration | Files | Phase |
|------|-------|----------|-------|-------|
| T028 | architect | 75 | `src/models/schema.sql` | Polish |

### Wave 12 (t=210) — Setup + User Story 2 + User Story 3
...
### Wave 13 (t=245) — User Story 2 + User Story 3
...
### Wave 14 (t=280) — Polish + Setup + User Story 2
...
| 3 | **T010** | backend-2 | 70 | 105 | 35 | 105 |
| 4 | **T011** | backend-1 | 105 | 140 | 35 | 140 |
| 5 | **T021** | backend-1 | 140 | 175 | 35 | 175 |
...
graph LR
    ...
    class T005,T008,T010,T016,T018,T002,T001 backend_2
    class T006,T027,T009,T015,T022 tester
    class T007,T003,T011,T021,T023,T024,T017 backend_1
    class T014,T004,T028,T026 architect
    class T012,T013,T020,T025,T019 frontend
    class T005,T008,T010,T011,T017,T019,T021,T023,T024 critical
```
