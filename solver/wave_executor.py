...
as JSON or a plain-text table. Execution itself is driven by
``python -m solver next`` (see ``solver.rounds`` / ``solver.briefs``).

Usage:
    python -m solver.wave_executor schedule.md [--format json|table]
"""
